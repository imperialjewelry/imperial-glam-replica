...
const MoissanitePendantsSection = () => {
  ...
  if (error) {
    console.error('Pendant products error:', error);
    return (
      <section className="py-16 bg-white">
        <div className="flex items-center justify-center">
          <div className="text-lg text-red-500">Error loading pendants</div>
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="py-16 bg-white">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-64 h-32 md:h-auto bg-gradient-to-br from-purple-600 to-blue-600 relative overflow-hidden flex items-center justify-center">
          <div 
            className="absolute inset-0 bg-cover bg-center opacity-30"
            style={{
              backgroundImage: `url('https://xdidixccpcgzbqqawywf.supabase.co/storage/v1/object/public/images/LION.webp')`
            }}
          />
            ...
            <div className="flex space-x-4 px-4 pb-4">
              {pendantProducts.length > 0 ? (
                ...
                <div className="flex items-center justify-center w-full py-8">
                  <div className="text-gray-500">No pendants available</div>
                </div>
              )}
            </div>
          </div>
