...
interface HipHopRingProductModalProps {
  product: HipHopRingProduct;
  onClose: () => void;
}

const HipHopRingProductModal = ({ product, onClose }: HipHopRingProductModalProps) => {
...
export default HipHopRingProductModal;
