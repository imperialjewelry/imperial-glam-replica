...
const CustomerReviews = () => {
  useEffect(() => {
    // Dynamically load EmbedSocial script
    ...
    return () => {
      // Optional cleanup if you want the script removed when unmounted
  ...
  return (
    <section className="py-16 bg-black text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        {/* Updated EmbedSocial Reviews Widget */}
        <div className="mb-12">
          <div className="embedsocial-hashtag" data-ref="c7f87cdbd72323b5db205677fc089e2470062c97">
            <a
