...
interface GlassesProductModalProps {
            ...
            <div className="space-y-6">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  {product.in_stock && <Badge className="bg-green-500 text-white">IN STOCK</Badge>}
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4 text-sm bg-gray-50 p-4 rounded-lg">
                  ...
                  {product.lens_color && (
                    <div>
                      <span className="font-medium text-gray-700">Lens Color:</span>
                      <div className="text-gray-900 font-semibold">{product.lens_color}</div>
                    </div>
                  )}
                  {product.frame_style && (
                    <div>
                      <span className="font-medium text-gray-700">Frame Style:</span>
                      <div className="text-gray-900 font-semibold">{product.frame_style}</div>
                    </div>
                  )}
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  {product.lens_color && (
                    <div>
                      ...
                      <span className="ml-2 text-gray-600">{product.lens_color}</span>
                    </div>
                  )}
                  {product.frame_style && (
                    <div>
                      <span className="font-medium">Frame Style:</span>
                      <span className="ml-2 text-gray-600">{product.frame_style}</span>
                    </div>
                  )}
                </div>
              </div>
...
export default GlassesProductModal;
