...
interface EngagementRingProductModalProps {
  product: EngagementRingProduct;
  onClose: () => void;
}

const EngagementRingProductModal = ({ product, onClose }: EngagementRingProductModalProps) => {
...
export default EngagementRingProductModal;
