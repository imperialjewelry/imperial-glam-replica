      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
          ...
          <div className="flex space-x-0 border-b border-gray-200">
            {['BEST SELLERS', 'NEW ARRIVALS'].map(tab => <Button key={tab} variant="ghost" onClick={() => setActiveTab(tab)} className={`px-4 py-2 rounded-none border-b-2 transition-colors ${activeTab === tab ? "border-blue-500 text-blue-600 bg-transparent" : "border-transparent text-gray-600 hover:bg-transparent hover:text-gray-900"}`}>
                {tab}
              </Button>)}
          </div>
        </div>
        ...
        <div className="relative">
          <div className="flex overflow-x-auto lg:grid lg:grid-cols-3 gap-6 pb-4 lg:pb-0 scrollbar-hide">
            {products.map(product => <div key={product.id} className="flex-shrink-0 w-80 lg:w-auto bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
                {/* Product image */}
                <div className="relative aspect-square overflow-hidden">
                  ...
                  {/* Size options */}
                  {product.sizes && <div className="absolute bottom-4 left-4 flex flex-wrap gap-1">
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    {product.originalPrice && <span className="ml-2 text-lg text-gray-400 line-through">
