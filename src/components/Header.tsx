          ...
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center justify-center space-x-8 text-sm font-medium">
              {navigation.map(item => {
                ...
                // Route "ALL PRODUCTS" to /best-deals
                return (
                  <Link
                    key={item}
                    to={
                      item === 'ALL PRODUCTS' ? '/best-deals' :
                      item === 'CHAINS' ? '/chains' :
            ...
            <div className="p-4 space-y-6">
              <div className="space-y-4">
                <div className="bg-gray-100 p-4 rounded-lg">
                  {/* Title changed to ALL PRODUCTS, link still /best-deals */}
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3 py-2">
                  <div className="w-12 h-12 rounded-lg flex-shrink-0 overflow-hidden">
                    <img src="https://xdidixccpcgzbqqawywf.supabase.co/storage/v1/object/public/images/6ACB04DC-1C32-49D1-996D-DFF4B862DA7D.webp" alt="
