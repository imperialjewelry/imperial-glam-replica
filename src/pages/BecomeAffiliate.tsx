  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Join the Imperial Jewelry affiliate network. Partner with a trusted name in fine and fashion jewelry."
        />
      </Helmet>
        ...
        <main className="flex-1 bg-background">
          <div className="max-w-4xl mx-auto px-4 py-12 md:py-20">
            ...
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Join the Imperial Affiliate Network</h1>
            ...
            <div className="prose prose-lg max-w-none mb-12 text-foreground/90">
              <p className="text-lg leading-relaxed mb-6">
                ...
                with rappers, athletes, models, and public figures, offering a full spectrum of jewelry — from
                accessible fashion pieces to ultra high-end designs.
              </p>
              <p className="text-lg leading-relaxed">
                Now, we're opening the doors for creators, athletes, and influencers to join our affiliate and
                partnership program.
              </p>
            </div>
            ...
            <section className="mb-12">
              ...
              <p className="text-lg text-foreground/90">
                Anyone passionate about the Imperial brand is encouraged to apply, even if you don't meet all of the
                above criteria.
              </p>
            </section>
              ...
              <div className="grid gap-6">
                ...
                <div>
                  ...
                  <p className="text-foreground/90">
                    Offerings that cater to every style and budget — from everyday fashion pieces to exclusive high-end
                    collections.
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-foreground/90">
                    We offer multiple financing options through Synchrony, Acima, Progressive, Snap, AFF, Affirm, and
                    Klarna, each capable of approving purchases up to $5,000 or more.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="text-center">
              ...
              <p className="text-lg text-foreground/90">
                ...
                <a href="mailto:imperialjewelryshop@gmail.com" className="text-primary hover:underline">
              ...
              <p className="text-lg text-foreground/90 mt-4">We look forward to partnering with you.</p>
            </section>
          </div>
        </main>
