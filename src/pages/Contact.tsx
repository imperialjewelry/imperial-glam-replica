      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          {contactInfo.map((info, index) => <Card key={index} className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <div className="space-y-1">
                  {info.details.map((detail, idx) => <p key={idx} className="text-gray-600 text-sm">
                      {detail}
                    </p>)}
                </div>
              </CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="email" id="email" name="email" value={formData.email} onChange={handleInputChange} required className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="your@email.com" />
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="tel" id="phone" name="phone" value={formData.phone} onChange={handleInputChange} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="(555) 123-4567" />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea id="message" name="message" value={formData.message} onChange={handleInputChange} required rows={6} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-vertical" placeholder="Tell us how we can help you..."></textarea>
              </div>

              <Button type="submit" disabled={isSubmitting} className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 text-lg">
        ...
        <div className="mt-16">
          ...
          <div className="flex justify-center">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3464.338343488329!2d-95.46823848783117!3d29.738919674974873!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640c16f38c46c87%3A0x9dea2daeead2580d!2s5085%20Westheimer%20Rd%2C%20Houston%2C%20TX%2077056!5e0!3m2!1sen!2sus!4v1756584160678!5m2!1sen!2sus" width="100%" height="450" style={{
            border: 0,
            maxWidth: '800px'
          }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="rounded-lg shadow-lg" />
          </div>
        </div>
      </div>
