...
const Diamond = () => {
  ...
  const products = [
    {
      id: 1,
      name: "Diamond Cuban Chain 14K Gold Premium",
      image: "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?auto=format&fit=crop&w=800&q=80",
      category: "14K SOLID GOLD / UNISEX",
      price: 2895,
      originalPrice: 3047,
      rating: 5,
      reviews: 342,
    ...
    {
      id: 2,
      name: "Diamond Tennis Chain 14K Gold Classic",
    ...
    {
      id: 3,
      name: "Diamond Figaro Chain 14K Gold",
      ...
      rating: 5,
      reviews: 189,
      badges: ["SHIPS TODAY", "5% OFF"]
    },
    {
      id: 4,
      name: "Diamond Cuban Chain White Gold",
      image: "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?auto=format&fit=crop&w=800&q=80",
      category: "14K SOLID GOLD / UNISEX",
      price: 3195,
      originalPrice: 3363,
    ...
    {
      id: 5,
      name: "Diamond Tennis Chain Rose Gold",
      image: "https://images.unsplash.com/photo-1602173574767-37ac01994b2a?auto=format&fit=crop&w=800&q=80",
      category: "14K SOLID GOLD / UNISEX",
      price: 3099,
      originalPrice: 3262,
    ...
    {
      id: 6,
      name: "Diamond Chain Stainless Steel",
      image: "https://images.unsplash.com/photo-1506630448388-4e683c67ddb0?auto=format&fit=crop&w=800&q=80",
      category: "STAINLESS STEEL / UNISEX",
      price: 699,
      originalPrice: 735,
      rating: 5,
      reviews: 87,
  ...
  const productTypes = [
    { name: "Cuban Chains", count: 16 },
    { name: "Ships Today", count: 1 },
    { name: "Tennis Chains", count: 16 },
    { name: "Diamond Chains", count: 32 },
    { name: "Figaro Chains", count: 1 }
  ];

  const colors = [
    { name: "Yellow Gold", count: 21 },
    { name: "White Gold", count: 16 },
    { name: "Rose Gold", count: 16 }
  ];

  const materials = [
    { name: "14K Solid Gold", count: 31 },
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Premium Diamond Collection - 14K Solid Gold Cuban, Tennis, and Figaro Diamond Chains
              </p>
      ...
      <div className={`flex ${isMobile ? 'flex-col' : 'flex-row'}`}>
        ...
        <div className={`flex-1 ${isMobile ? 'py-4 px-4' : 'py-8 px-8'}`}>
          ...
          <div className="flex items-center justify-between mb-6">
            <span className="text-lg font-semibold">53 Products</span>
