...
const PoloG = () => {
  ...
  const applyFilters = () => {
    ...
    if (selectedFilters.productTypes.length > 0) {
      filtered = filtered.filter((p) =>
        selectedFilters.productTypes.includes(p.product_type)
      );
    }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section – image + overlay; text shifted toward the top */}
      <div className="relative w-full bg-black">
        ...
        {/* Shift text upward: align to top and use responsive top padding */}
        <div className="absolute inset-0 flex items-start pointer-events-none">
          <div className="max-w-7xl mx-auto px-4 w-full pt-6 sm:pt-10 md:pt-14 lg:pt-16 xl:pt-20">
            <div className="text-center text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.85)] my-0 py-[8px] px-0 mx-0">
              <h1 className="text-4xl font-extrabold mb-3 lg:text-5xl">
                POLO G 🐐 COLLECTION
              </h1>
