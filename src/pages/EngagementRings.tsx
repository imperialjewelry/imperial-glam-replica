...
const EngagementRings = () => {
  ...
  const {
    ...
    filters,
    loading
  } = useProductFilters('engagement_ring_products');
  ...
  return <div className="min-h-screen bg-white">
      ...
      {!isMobile && <div className="bg-gray-50 py-12 px-8">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">ENGAGEMENT RINGS</h1>
            <p className="text-lg text-gray-600">All Diamond 925 Silver, 14K White, Yellow and Rose Gold Engagement Rings</p>
          </div>
        </div>}
      ...
      {/* Product Modal */}
      {selectedProduct && <EngagementRingProductModal product={selectedProduct} onClose={() => setSelectedProduct(null)} />}
