...
const EngagementRings = () => {
  ...
  const productTypes = [
    { name: "Halo Rings", count: 4 },
    { name: "Solitaire Rings", count: 3 },
    { name: "Pave Rings", count: 2 },
    { name: "Side Stone Rings", count: 2 },
    { name: "Three Stone Rings", count: 1 }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Premium Moissanite Engagement Rings
            </p>
          </div>
        </div>
      </section>
