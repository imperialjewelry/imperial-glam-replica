...
const Glasses = () => {
  ...
  const products = [
    {
      id: 1,
      name: "Custom Sunglasses 14K Gold Frame",
    ...
    {
      id: 3,
      name: "Classic Glasses Rose Gold",
      image: "https://images.unsplash.com/photo-1511499767150-a48a237f0083?auto=format&fit=crop&w=800&q=80",
      category: "CLASSIC / UNISEX",
      price: 1200,
      originalPrice: 1265,
      rating: 5,
      reviews: 89,
    ...
    {
      id: 4,
      name: "Aviator Glasses White Gold",
      image: "https://images.unsplash.com/photo-1473496169904-658ba7c44d8a?auto=format&fit=crop&w=800&q=80",
      category: "AVIATOR / UNISEX",
      price: 644,
      originalPrice: 678,
      rating: 5,
      reviews: 234,
    ...
    {
      id: 5,
      name: "Rectangle Glasses Yellow Gold",
      image: "https://images.unsplash.com/photo-1508296695146-257a814070b4?auto=format&fit=crop&w=800&q=80",
      category: "RECTANGLE / UNISEX",
      price: 527,
      originalPrice: 555,
      rating: 5,
      reviews: 678,
    ...
    {
      id: 6,
      name: "Square Glasses White Gold",
      image: "https://images.unsplash.com/photo-1511499767150-a48a237f0083?auto=format&fit=crop&w=800&q=80",
      category: "SQUARE / UNISEX",
      price: 1135,
      originalPrice: 1195,
      rating: 5,
      reviews: 345,
      ...
      <div className={`flex ${isMobile ? 'flex-col' : 'flex-row'}`}>
        ...
        <div className={`flex-1 ${isMobile ? 'py-4 px-4' : 'py-8 px-8'}`}>
          ...
          <div className="flex items-center justify-between mb-6">
            <span className="text-lg font-semibold">20 Products</span>
