...
const VvsDiamondSimulants = () => {
  ...
  const products = [
    {
      ...
      category: "VVS DIAMOND SIMULANT / UNISEX",
      price: 895,
      originalPrice: 942,
      rating: 5,
      reviews: 247,
    ...
    {
      id: 2,
      name: "VVS Tennis Chain 14K Gold Premium",
    ...
    {
      id: 3,
      name: "VVS Diamond Simulant Tennis Bracelet",
    ...
    {
      id: 4,
      name: "VVS Cross Pendant 14K Gold",
      image: "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?auto=format&fit=crop&w=800&q=80",
      category: "VVS DIAMOND SIMULANT / UNISEX",
      price: 565,
      originalPrice: 594,
    ...
    {
      id: 5,
      name: "VVS Clustered Earrings Premium",
      image: "https://images.unsplash.com/photo-1602173574767-37ac01994b2a?auto=format&fit=crop&w=800&q=80",
      category: "VVS DIAMOND SIMULANT / UNISEX",
      price: 425,
      originalPrice: 447,
    ...
    {
      id: 6,
      name: "VVS Diamond Ring Premium Collection",
      image: "https://images.unsplash.com/photo-1506630448388-4e683c67ddb0?auto=format&fit=crop&w=800&q=80",
      category: "VVS DIAMOND SIMULANT / UNISEX",
      price: 687,
      originalPrice: 722,
  ...
  const productTypes = [
    { name: "Cuban Chains", count: 2 },
    { name: "Ships Today", count: 43 },
    { name: "Tennis Chains", count: 2 },
    { name: "Tennis Bracelets", count: 2 },
    { name: "Cross Chains", count: 1 },
    { name: "Mariner Link Chains", count: 2 },
    { name: "Bundles", count: 3 },
    { name: "Clustered Earrings", count: 2 },
    { name: "Clustered Tennis Chains", count: 1 },
    { name: "Cross Earrings", count: 1 },
    { name: "Cross Link Bracelets", count: 1 },
    { name: "Cuban Link Bracelets", count: 4 },
    { name: "Cuban Link Chains", count: 1 },
    { name: "Earrings", count: 1 },
    { name: "Pendants", count: 10 },
    { name: "Rings", count: 8 },
  ...
  const colors = [
    { name: "Yellow Gold", count: 9 },
    { name: "White Gold", count: 44 },
  ...
  const gemstones = [
    { name: "VVS Diamond Simulant (CZ)", count: 10 },
    { name: "VVS Diamond Simulants", count: 4 },
    { name: "VVS Diamond Simulants (CZ)", count: 19 }
  ];

  const diamondCuts = [
    { name: "Round Cut", count: 4 }
  ];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Premium VVS Diamond Simulant Collection - Chains, Rings, Earrings, Bracelets & More
              </p>
      ...
      <div className={`flex ${isMobile ? 'flex-col' : 'flex-row'}`}>
        ...
        <div className={`flex-1 ${isMobile ? 'py-4 px-4' : 'py-8 px-8'}`}>
          ...
          <div className="flex items-center justify-between mb-6">
            <span className="text-lg font-semibold">54 Products</span>
