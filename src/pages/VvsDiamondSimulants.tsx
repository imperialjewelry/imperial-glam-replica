...
const VvsDiamondSimulants = () => {
  ...
  const [selectedFilters, setSelectedFilters] = useState({
    ...
    color: [] as string[],
    material: [] as string[],
    caratWeight: [] as string[],
    cutQuality: [] as string[],
    clarityGrade: [] as string[]
  });
  ...
  const renderMobileFilters = () => showFilters && <div className="bg-white border rounded-lg mb-6 overflow-hidden">
        ...
        {/* Carat Weight Filter */}
        <Collapsible open={openSections.caratWeight} onOpenChange={() => toggleSection('caratWeight')}>
          <CollapsibleTrigger className="flex items-center justify-between w-full p-4 text-left border-b hover:bg-gray-50">
            <span className="font-medium">CARAT WEIGHT</span>
            <ChevronDown className={`w-4 h-4 transition-transform ${openSections.caratWeight ? 'rotate-180' : ''}`} />
          </CollapsibleTrigger>
          <CollapsibleContent className="p-4 border-b">
            <div className="space-y-3">
        ...
        {/* Cut Quality Filter */}
        <Collapsible open={openSections.cutQuality} onOpenChange={() => toggleSection('cutQuality')}>
          <CollapsibleTrigger className="flex items-center justify-between w-full p-4 text-left border-b hover:bg-gray-50">
            <span className="font-medium">CUT QUALITY</span>
            <ChevronDown className={`w-4 h-4 transition-transform ${openSections.cutQuality ? 'rotate-180' : ''}`} />
          </CollapsibleTrigger>
          <CollapsibleContent className="p-4 border-b">
            <div className="space-y-3">
        ...
        <Collapsible open={openSections.clarityGrade} onOpenChange={() => toggleSection('clarityGrade')}>
          <CollapsibleTrigger className="flex items-center justify-between w-full p-4 text-left hover:bg-gray-50">
            ...
            <ChevronDown className={`w-4 h-4 transition-transform ${openSections.clarityGrade ? 'rotate-180' : ''}`} />
          </CollapsibleTrigger>
