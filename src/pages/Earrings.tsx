...
const Earrings = () => {
  ...
  const [products, setProducts] = useState<EarringProduct[]>([]);
  ...
  const productTypes = [
    { name: "Stud Earrings", count: 4 },
    { name: "Hoop Earrings", count: 3 },
    { name: "Drop Earrings", count: 2 },
    { name: "Dangle Earrings", count: 2 },
    { name: "Chandelier Earrings", count: 1 },
  ];
  ...
  const chainTypes: { name: string; count: number; }[] = [];
