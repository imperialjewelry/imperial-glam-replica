              ...
              <CardContent className="p-8">
                ...
                <Accordion type="single" collapsible className="w-full">
                  {category.questions.map((faq, index) => (
                    <AccordionItem key={index} value={`${categoryIndex}-${index}`} className="border-b border-gray-200">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <ul className="space-y-2 text-blue-600">
                <li><a href="#" className="hover:underline">• Ring Sizing Guide</a></li>
                <li><a href="#" className="hover:underline">• Chain Length Guide</a></li>
                <li><a href="#" className="hover:underline">• Diamond Education</a></li>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <ul className="space-y-2 text-blue-600">
                ...
                <li><a href="#" className="hover:underline">• Request Custom Quote</a></li>
                <li><a href="#" className="hover:underline">• Schedule Appointment</a></li>
              </ul>
            </CardContent>
          </Card>
        </div>
